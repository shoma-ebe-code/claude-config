...
詳細は Zenn 記事を参照: [Claude Code の設定を「設計」する — 場当たりルールからV2憲法へのリビルド記](https://zenn.dev/ojt/articles/claude-code-v2-constitution)
...
- [terraform plan をClaudeに解析させる4つのプロンプトパターン](https://zenn.dev/ojt/articles/terraform-plan-claude-prompt-patterns)
- [Claude Code の設定を「設計」する — V2憲法へのリビルド記](https://zenn.dev/ojt/articles/claude-code-v2-constitution)
